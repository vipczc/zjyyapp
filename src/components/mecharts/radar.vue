<template>
    <div>
        <p v-show="maintitle" class="radar_title">{{maintitle}}<span v-show="secondtitle">{{secondtitle}}</span></p>
            ...
            drawLine() {
                ...
                chartObj.setOption({
                    ...
                    radar: {
                        ...
                        splitArea: {
                            areaStyle: {
                                color: ["rgba(252,252,253,1)", "rgba(250,250,250,1)"]
                            }
                        }
                    },
                    textStyle: {
                    ...
                    series: {
                        ...
                        data: [{
                            value: [vm.barnumber[0].value, vm.barnumber[1].value, vm.barnumber[2].value, vm.barnumber[3].value, vm.barnumber[4].value, vm.barnumber[5].value]
